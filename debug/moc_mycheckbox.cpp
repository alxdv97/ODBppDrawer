...
QT_MOC_LITERAL(3, 25, 18), // "doEmitStateChanged"
QT_MOC_LITERAL(4, 44, 1) // "i"

    },
    "myCheckBox\0stateChanged\0\0doEmitStateChanged\0"
    "i"
};
...
void myCheckBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->doEmitStateChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (myCheckBox::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myCheckBox::stateChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myCheckBox::stateChanged(int _t1, int _t2)
{
